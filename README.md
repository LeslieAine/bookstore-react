...
**bookstore** "Bookstore" is a website for all readers and fans of books. It is a Single Page App (SPA) that allows users to:
...
```sh
  git clone https://github.com/LeslieAine/bookstore.git
  cd bookstore
```
